...
Сгенерированные сайты теперь получают тематическое изображение. ИИ выбирает смысловую категорию изображения, а backend подставляет подходящую картинку из заранее подготовленной библиотеки открытых изображений.
